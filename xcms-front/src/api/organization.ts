...
export const orgApi = {
  ...
  createDept: (data: Schemas['DepartmentCreateRequest']) => http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/admin/org/dept/create', data),
  updateDept: (data: Schemas['DepartmentUpdateRequest']) => http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/admin/org/dept/update', data),
  ...
  createPosition: (data: Schemas['PositionCreateRequest']) => http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/admin/org/position/create', data),
  ...
  createUserGroup: (data: Schemas['UserGroupCreateRequest']) => http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/admin/org/group/create', data),
