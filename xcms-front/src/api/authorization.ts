...
export const authzApi = {
  getRolePermissions: (roleId: number) =>
    http.post<unknown, Unwrap<Schemas['ApiResponseListPermissionDTO']>>('/api/admin/role-permission/get', { id: roleId }),
  ...
  listPermissions: (): Promise<PermissionDTO[]> =>
    http.post<unknown, Unwrap<Schemas['ApiResponseListPermissionDTO']>>('/api/admin/permission/list', {}),
  ...
  assignPermissions: (roleId: number, permissions: { permId: number; permType?: string }[]) =>
    http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/api/admin/role-permission/assign', {
      roleId,
      permissions,
    }),
};
...
export const dataRuleApi = {
  list: (resourceType: string): Promise<DataRuleDTO[]> =>
    http.post<unknown, Unwrap<Schemas['ApiResponseListDataRuleDTO']>>('/api/admin/data-rule/list', { resourceType }),
  create: (data: DataRuleCreateRequest): Promise<DataRuleDTO> =>
    http.post<unknown, Unwrap<Schemas['ApiResponseDataRuleDTO']>>('/api/admin/data-rule/create', data),
  delete: (id: number) =>
    http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/api/admin/data-rule/delete', { id }),
  // 后端 DataRuleBindRequest 以 id 表示规则 ID
  bind: (ruleId: number, roleId: number, scopeValue?: string) =>
    http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/api/admin/data-rule/bind', { id: ruleId, roleId, scopeValue }),
  unbind: (ruleId: number, roleId: number) =>
    http.post<unknown, Unwrap<Schemas['ApiResponseVoid']>>('/api/admin/data-rule/unbind', { id: ruleId, roleId }),
};
